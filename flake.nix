  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        let
          pkgs = pkgsFor system;
          quickshot = pkgs.callPackage ./nix/package.nix { };
        in
        {
          inherit quickshot;
          default = quickshot;
      ...
      apps = forAllSystems (
        ...
        let
          ...
          quickshotApp = {
            type = "app";
            program = lib.getExe self.packages.${system}.quickshot;
            meta.description = "Run the Quickshot Qt application";
          };
          generateCompileCommands = generateCompileCommandsAppFor pkgs;
        in
        {
          default = quickshotApp;
          quickshot = quickshotApp;
      ...
      checks = forAllSystems (
        ...
        in
        {
          package = self.packages.${system}.quickshot;
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            inputsFrom = [ self.packages.${system}.quickshot ];
            packages =
      ...
      formatter = forAllSystems (
        ...
        in
        pkgs.writeShellScriptBin "quickshot-format" ''
      ...
      templates = {
        default = {
          path = ./.;
          description = "C++20 and Qt 6 project with Nix, CMake, direnv, and Git hooks";
        };
        qt = {
          path = ./.;
          description = "C++20 and Qt 6 project with Nix, CMake, direnv, and Git hooks";
